...
/**
 * Canonical Cluster IDs (must align with scoring.js aggregation):
 ...
 *
 * Each question:
 * - clusters: [{ id, w }]             // cluster weights
 * - majorsHints?: [{ id, w }]         // optional major nudges
...
export const QUESTIONS_LIKERT = [
  {
    ...
    clusters: [
      { id: "COMPUTING_AI", w: 1.0 },
      { id: "SCIENCES_QUANT", w: 0.6 }
    ],
    majorsHints: [
      { id: "SOC_CS", w: 0.6 },
      { id: "SOC_AI", w: 0.6 }
  ...
  },
  {
    ...
    clusters: [
      { id: "MUSIC_PERF", w: 1.0 },
      { id: "HUMANITIES_CULTURE", w: 0.6 },  // switched (higher than Design)
      { id: "DESIGN_ARCH", w: 0.4 }          // lower than Humanities
    ],
    majorsHints: [
      { id: "MUS_MUS", w: 0.9 },
      { id: "CHS_TPS", w: 0.4 }
  ...
  },
  {
    ...
    clusters: [
      { id: "SCIENCES_QUANT", w: 0.8 },
      { id: "ENGINEERING_TECH", w: 0.8 },
      { id: "SOCIAL_SCI", w: 0.4 }
    ],
    majorsHints: [
      { id: "ENG_ENV", w: 0.6 },
  ...
  },
  {
    ...
    clusters: [
      { id: "SCIENCES_QUANT", w: 1.0 },
      { id: "COMPUTING_AI", w: 0.6 },
      { id: "BUSINESS_MGMT", w: 0.5 }
    ],
    majorsHints: [
      { id: "CHS_DSA", w: 0.7 },
      { id: "SOC_BA", w: 0.6 },
