...
export const majorsBatch2 = [
  ...
  // ---------------------------------------------------
  // COLLEGE OF DESIGN AND ENGINEERING – DESIGN
  // ---------------------------------------------------
  {
    id: "DES_ARCH",
    name: "Architecture",
...
export const majorsBatch3 = [
  ...
  // ---------------------------------------------------
  {
    ...
    description:
      "Engage deeply with Chinese culture, history, and language. Explore classical and modern texts to understand China’s role in a global context.",
